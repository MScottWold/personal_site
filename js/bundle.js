...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _rotatable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rotatable */ \"./src/js/rotatable.js\");\n/* harmony import */ var _background_artboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./background/artboard */ \"./src/js/background/artboard.js\");\n/* harmony import */ var _background_animated_background__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./background/animated_background */ \"./src/js/background/animated_background.js\");\n\n\n\n$(function () {\n  // Animated Canvas\n  var background = new _background_animated_background__WEBPACK_IMPORTED_MODULE_2__.default('background-canvas', _background_artboard__WEBPACK_IMPORTED_MODULE_1__.artboard); // Rotating element\n\n  var rotatable = new _rotatable__WEBPACK_IMPORTED_MODULE_0__.default($('.rotatable > *'));\n  rotatable.toggleAnimation(); // Nav menu button\n\n  $('#nav-menu').on('click', function (e) {\n    if (!e.target.classList.contains('inert')) {\n      $(this).toggleClass('expanded');\n    }\n  }); // Code for projects panel\n\n  var $tabList = $('.tab-list');\n  var $activeLink = $tabList.find('a.active');\n  var $panel = $($activeLink.attr('href'));\n  $tabList.on('click', '.panel-title', function (e) {\n    e.preventDefault();\n    var $link = $(this);\n    var id = this.hash;\n\n    if (id && !$link.is('.active')) {\n      $panel.removeClass('active');\n      $activeLink.removeClass('active');\n      $panel = $(id).addClass('active');\n      $activeLink = $link.addClass('active');\n    }\n  }); // Code for image previews\n\n  var $modal = $('.modal');\n  var $previews = $modal.find('.img-preview');\n  var currentPanelIdx; // Open full image preview\n\n  $('.thumbs').on('click', '.thumb-panel', function () {\n    currentPanelIdx = Number(this.dataset.idx);\n    $previews[currentPanelIdx].style.display = 'flex';\n    $modal.css({\n      display: 'block'\n    });\n  }); // Close image preview\n\n  $modal.find('.close-modal').on('click', function () {\n    $previews.css({\n      display: ''\n    });\n    $modal.css({\n      display: ''\n    });\n    currentPanelIdx = undefined;\n  }); // View next/previous image\n\n  $modal.find('.nav-preview').on('click', function () {\n    var deltaIdx = Number(this.dataset.deltaIdx);\n    var newIdx = (currentPanelIdx + deltaIdx) % $previews.length;\n\n    if (newIdx < 0) {\n      newIdx = $previews.length - 1;\n    }\n\n    $previews[currentPanelIdx].style.display = '';\n    $previews[newIdx].style.display = 'flex';\n    currentPanelIdx = newIdx;\n  });\n});\n\n//# sourceURL=webpack://personal_site/./src/js/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar Rotatable = /*#__PURE__*/function () {\n  function Rotatable($faces) {\n    var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1500;\n\n    _classCallCheck(this, Rotatable);\n\n    this.$faces = $faces;\n    this.delay = delay;\n    this.showIdx = 1;\n  }\n\n  _createClass(Rotatable, [{\n    key: \"toggleAnimation\",\n    value: function toggleAnimation() {\n      if (this.interval) {\n        this.interval = clearInterval(this.interval);\n      } else {\n        this.interval = setInterval(this._rotateClasses.bind(this), this.delay);\n      }\n    }\n  }, {\n    key: \"_rotateClasses\",\n    value: function _rotateClasses() {\n      var _this = this;\n\n      // get indices for each face of box; allows for any number of panels\n      var maxLength = this.$faces.length;\n      var nextIdx = (this.showIdx + 1) % maxLength;\n      var bottomIdx = (this.showIdx - 1 + maxLength) % maxLength;\n      var backIdx = (bottomIdx - 1 + maxLength) % maxLength;\n      this.$faces.each(function (idx, ele) {\n        switch (idx) {\n          case nextIdx:\n            ele.className = 'next';\n            break;\n\n          case _this.showIdx:\n            ele.className = 'front';\n            break;\n\n          case bottomIdx:\n            ele.className = 'bottom';\n            break;\n\n          case backIdx:\n            ele.className = 'back';\n            break;\n\n          default:\n            ele.className = 'waiting';\n            break;\n        }\n      });\n      this.showIdx = (this.showIdx + 1) % maxLength;\n    }\n  }]);\n\n  return Rotatable;\n}();\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Rotatable);\n\n//# sourceURL=webpack://personal_site/./src/js/rotatable.js?");
